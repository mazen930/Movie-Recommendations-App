...
public class ListOfItems2 extends AppCompatActivity {
    ...
    ListView listView;
    int active=0;
    public static int Listitem2_active=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        active= info.getInt("Current");
        try {
            nameArray=setnames(s.search);//send resultset in parameter
        ...
        listView.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Toast.makeText(ListOfItems2.this, item, Toast.LENGTH_LONG).show();
